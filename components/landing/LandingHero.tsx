...
export default function LandingHero({ banner }: { banner: HeroBanner | null }) {
  return (
    <section className="relative bg-ink text-paper overflow-hidden pt-6 pb-16 md:pt-4 md:pb-24">
      <div className="max-w-6xl mx-auto px-6 md:px-10 relative">
        <p className="eyebrow text-paper/60 mb-1">Fashion Designer</p>
        ...
        <p className="max-w-xs text-sm text-paper/70 mt-4">
          Where fabric meets finesse and creativity meets couture.
        </p>

        <div className="relative mt-8 md:mt-10 rounded-[28px] overflow-hidden aspect-[3/4] md:aspect-[16/9] max-w-3xl mx-auto md:mx-0 bg-ink/40">
          {banner ? (
          ...
          {/* Crosshair + rotating badge decoration, Apple-portfolio style */}
          <svg
            className="absolute left-4 bottom-4 md:left-6 md:bottom-6 opacity-70"
            width="26"
            height="26"
            viewBox="0 0 26 26"
            fill="none"
          ...
          <div className="absolute right-4 top-4 md:right-6 md:top-6 w-16 h-16 md:w-20 md:h-20">
          ...
          <div className="absolute left-4 top-4 md:left-6 md:top-6 text-left">
